...
exports.isStudent = (req, res, next) => {
    try {
        ...
        console.log('Error while cheching user validity with student ACCOUNT_TYPE');
        console.log(error);
        return res.status(500).json({
            success: false,
            error: error.message,
            messgae: 'Error while cheching user validity with student ACCOUNT_TYPE'
        })
    }
}
...
exports.isInstructor = (req, res, next) => {
    try {
        ...
        console.log('Error while cheching user validity with Instructor ACCOUNT_TYPE');
        console.log(error);
        return res.status(500).json({
            success: false,
            error: error.message,
            messgae: 'Error while cheching user validity with Instructor ACCOUNT_TYPE'
        })
    }
}
...
exports.isAdmin = (req, res, next) => {
    try {
        ...
        console.log('Error while cheching user validity with Admin ACCOUNT_TYPE');
        console.log(error);
        return res.status(500).json({
            success: false,
            error: error.message,
            messgae: 'Error while cheching user validity with Admin ACCOUNT_TYPE'
        })
    }
}
