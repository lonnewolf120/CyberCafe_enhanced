...
exports.courseEnrollmentEmail = (COURSE_NAME, name) => {
    return `<!DOCTYPE html>
    <html>
    ...
    <body>
        <div class="container">
            ...
            <div class="body">
                <p>Dear ${name},</p>
                <p>You have successfully registered for the course <span class="highlight">"${COURSE_NAME}"</span>. We
            ...
            <a href="mailto:iftekharulislam360@gmail.com">iftekharulislam360@gmail.com</a>. We are here to help!</div>
        </div>
    </body>
