  ...
  return (
    <div className="">
      <Button
        ...
        className="flex items-center rounded-lg bg-caribbeangreen-500 hover:bg-caribbeangreen-100 px-4 py-2 
        text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90 
        focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
      >
        <BiSearchAlt className="w-5 h-5 text-caribbeangreen-300 mr-2" />
        <span>Search</span>
      </Button>
