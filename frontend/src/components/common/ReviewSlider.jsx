              ...
              <SwiperSlide key={i}>
                <div className="flex flex-col gap-3 bg-richblack-800 p-3 text-[14px] text-richblack-25 min-h-[180px] max-h-[180px] glass-bg">
                  <div className="flex items-center gap-4">
                    <Img
                      src={
                        review?.IMAGE
                          ? review?.IMAGE
                          : `https://api.dicebear.com/5.x/initials/svg?seed=${review?.FIRST_NAME} ${review?.LAST_NAME}`
                      }
                      alt=""
                      className="h-9 w-9 rounded-full object-cover"
                    />
                    <div className="flex flex-col">
                      <h1 className="font-semibold text-richblack-5 capitalize">{`${review?.FIRST_NAME} ${review?.LAST_NAME}`}</h1>
                  ...
                  <p className="font-medium text-richblack-25">
                    {
                      //FIXME: cannot read properties of undefined split()
