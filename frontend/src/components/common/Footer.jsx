      ...
      <div className="flex flex-row items-center justify-between w-11/12 max-w-maxContent text-richblack-400 mx-auto pb-14 text-sm">
        ...
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          ...
          <div className="text-center flex flex-col sm:flex-row ">
            <div className="flex ">
              <span> Made with 🖤 by I </span>

              <Link to='https://github.com/lonnewolf120' target="__blank" className="text-white hover:underline mr-1"
              >
                ftekharul Islam
              </Link>
            </div>
            <span> © 2024 CyberCafe (Hacker's Lair)</span>
          </div>

          <div className="flex items-center">
            <a href="https://www.linkedin.com/iftekharul-islam/" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImLinkedin2 size={17} />
            </a>
            <a href="https://www.github.com/lonnewolf120" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImGithub size={17} />
            </a>
          </div>
