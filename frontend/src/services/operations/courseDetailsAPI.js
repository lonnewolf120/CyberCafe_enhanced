...
export const fetchCourseDetails = async (COURSE_ID) => {
  ...
  try {
    const response = await apiConnector("POST", COURSE_DETAILS_API, { COURSE_ID, })
...
// export const fetchCourseForCategories = async (data) => {
//     let result = []
//     console.log("data for fetchCourses: ", data)
//   try {
//     const response = await apiConnector("POST", COURSE_OF_CATEGORIES_API,data)
//     console.log("COURSE_CATEGORIES_API RESPONSE............", response)
//     if (!response?.data?.success) {
//       throw new Error("Could Not Fetch Course Categories")
//     }
...
export const getEnrolledStudents = async(COURSE_ID, token) => {
  ...
  try {
    ...
    console.log("STUDENT ENROLLED COURSES API RESPONSE", response)
    if (!response?.data?.success) {
      throw new Error("Could Not Fetch Instructor Courses")
    }
    result = response?.data?.data
  } catch (error) {
    console.log("STUDENT ENROLLED COURSES API ERROR............", error)
    toast.error(error.response.data.message)
  }
  return result
}
...
export const getFullDetailsOfCourse = async (COURSE_ID, token) => {
  // const toastId = toast.loading("Loading...")
  //   dispatch(setLoading(true));
  let result = null
  try {
...
export const createRating = async (data, token) => {
  const toastId = toast.loading("Loading...")
  console.log("rating data: ", data, "token: ", token)
  let success = false
  try {
