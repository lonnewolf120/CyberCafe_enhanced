...
function CourseDetails() {
  ...
  // Getting COURSE_ID from url parameter
  ...
  useEffect(() => {
    ...
    const fectchCourseDetailsData = async () => {
      try {
        const res = await fetchCourseDetails(COURSE_ID)
  ...
  console.log("response (CourseDetails.js): ", response)

  // Calculating Avg Review count
  const [avgReviewCount, setAvgReviewCount] = useState(0)
  useEffect(() => {
    const count = GetAvgRating(response?.data?.courseDetails[0].RATING)
  ...
  console.log("Course details (from CourseDetails): ", response?.data?.courseDetails[0])
  // extract course data
  const {
    COURSE_NAME,
    COURSE_DESCRIPTION,
            ...
            <div className={`mb-5 flex flex-col justify-center gap-4 py-5 text-lg text-richblack-5`}>
              ...
              <div className="flex flex-wrap gap-5 text-lg">
                <p className="flex items-center gap-2">
                  {" "}
                  <BiInfoCircle /> Created at {formatDate(CREATED_AT)}
                </p>
      ...
      <div className="mx-auto box-content px-4 text-start text-richblack-5 lg:w-[1260px]">
        <div className="mx-auto max-w-maxContentTab lg:mx-0 xl:max-w-[810px]">
          ...
          <div className="my-8 border border-richblack-600 p-8">
            ...
            <div className="mt-3">
              {WHAT_YOU_WILL_LEARN && (
                WHAT_YOU_WILL_LEARN?.split(',').map((line, index) => (
          ...
          <div className="max-w-[830px] mt-9">
            ...
            <div className="mb-12 py-4">
              ...
              <div className="flex items-center gap-4 py-4">
                ...
                /> */}
                <div>
                  <p className="text-lg capitalize flex items-center gap-2 font-semibold">{`${FIRST_NAME}`}
